...
extension Dictionary {
    ...
    func attributes() throws -> SAMParams  {
        guard let json = self as? SAMParams else {
            throw SAMError.invalidProperty("JSON response", self)
        }
        
        guard var attributes = json["attributes"] as? Parameters else {
            throw SAMError.missingParam("JSON response - attributes")
        }
    ...
    static func formatData(with id: Any, type: String, attributes: SAMParams) -> SAMParams {
